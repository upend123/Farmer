...
fun prevSales(){
    SalesScreen(onBackClick = {}, onAddNewSalesClick = {})
}

@Composable
fun SalesScreen(
    onAddNewSalesClick: () -> Unit,
    onBackClick: () -> Unit,
){
    Column(
        modifier = Modifier
        ...
        HeaderWithoutManuIcon(
            title = "Sales", isFirstTrailingIcon = true, morningDropDown = false,
            isDateAndMorningBar = true, onFirstTrailingIconClick = { onAddNewSalesClick()},
