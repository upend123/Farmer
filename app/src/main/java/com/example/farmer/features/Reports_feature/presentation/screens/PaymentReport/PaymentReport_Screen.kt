package com.example.farmer.features.Reports_feature.presentation.screens.PaymentReport
...
fun PaymentReportScreen(
    ...
    Column(
        ...
        ReportsHeader(title = "Payment Report", isFirstTrailingIcon = true, isSecondMoreTrailingIcon = true, firstTrailingIcon = R.drawable.baseline_print_24, secondTrailingIcon = R.drawable.baseline_screen_share_24,
