package com.example.farmer.features.Reports_feature.presentation.screens.PaymentAndSales
...
@Composable
fun PaymentAndSalesReportScreen(onBackClick: () -> Unit = {}){
    Column(
        modifier = Modifier
            .fillMaxSize()
            .padding(
        ...
        ReportsHeader(title = "Payment & Sales Report", isFirstTrailingIcon = true, isSecondMoreTrailingIcon = true, firstTrailingIcon = R.drawable.baseline_print_24, secondTrailingIcon = R.drawable.baseline_screen_share_24,
