package com.example.farmer.features.Reports_feature.presentation.screens.ShiftReport
...
fun ShiftReportScreen(
    ...
    Column(
        ...
        ReportsHeader(title = "Shift Report", isFirstTrailingIcon = true, isSecondMoreTrailingIcon = true, firstTrailingIcon = R.drawable.baseline_print_24, secondTrailingIcon = R.drawable.baseline_screen_share_24,
