package com.example.farmer.features.Reports_feature.presentation.screens.CreditOrDebitReports
...
@Composable
fun CreditorDebitReportsScreen(
    onBackClick:  () -> Unit = {}
){
    Column(
        modifier = Modifier
        ...
        ReportsHeader(title = "Credit/Debit Report",
            isBothDropdownOptions = false,
